 ...
 *
 */
class OutsourcingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 80, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '氏名', 'precision' => null, 'fixed' => null],
        'postalcode' => ['type' => 'string', 'length' => 10, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '郵便番号', 'precision' => null, 'fixed' => null],
        'address' => ['type' => 'string', 'length' => 240, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '住所', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'created' => '2017-02-05 07:51:55',
            'modified' => '2017-02-05 07:51:55',
